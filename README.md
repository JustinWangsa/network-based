...
- **important** if you are using live server to debug, change the server host to localhost:5500, or else it will be blocked by cors. and from the client side, fetch using these optionally 
``` js
    fetch('path/to/api',{
